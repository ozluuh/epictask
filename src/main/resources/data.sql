...
INSERT INTO user(email, password, name, github_user) VALUES('mail@fakemail.com','$2a$12$m2MQOl/T6q76zriCIhCEJe6Qg7P775So7EPtv.Fraj2D2y3vauvAO', 'fake user', 'joao');
INSERT INTO user(email, password, name, github_user) VALUES('fake@testmail.com','$2a$12$m2MQOl/T6q76zriCIhCEJe6Qg7P775So7EPtv.Fraj2D2y3vauvAO', 'fake user 2', 'maria');
INSERT INTO user(email, password, name, github_user) VALUES('admin@fiap.com.br','$2a$12$pX06soWOw7CuDvDGWMnu1OAmQActLRVufCvjfGK76ZMW3XSW.dPLy', 'Admin FIAP', 'joao');
